...
export const I18N = {
  en: {
    ...
    lead_stack: "Perception flows up the left, decisions flow down the right, and the two meet at a shared world model, all watched by a safety supervisor and clocked at three timescales. Highlighted blocks are where my published and patented work lives.",
    ...
    eb_focus: "What I research", t_focus: "Four questions, ",
    lead_focus: "My work lives where perception, learning, control, and systems overlap.",
    ...
    lead_areas: "The recurring questions behind my publications.",
  ...
  ar: {
    ...
    lead_stack: "يصعد الإدراك على اليسار، وتنزل القرارات على اليمين، ويلتقيان عند نموذج عالمٍ مشترك، يراقبهما مشرفُ سلامة، ويُضبط الزمن على ثلاثة مقاييس. الكتل المميّزة هي حيث يقع عملي المنشور والمُبرَّأ.",
    ...
    eb_focus: "ما أبحث فيه", t_focus: "أربعة أسئلة، ",
    lead_focus: "يقع عملي حيث يتقاطع إدراك الآلة وتعلّمها والتحكّم بها ونمذجتها.",
    ...
    lead_areas: "الأسئلة المتكرّرة خلف أبحاثي.",
